...
const features = [
  { icon: Shield, title: 'Private & Exclusive', desc: 'All listings are owner-verified and available exclusively through our trusted program.' },
  { icon: Headphones, title: '24/7 Concierge', desc: 'World-class concierge services available around the clock for every guest.' },
  { icon: Waves, title: 'Waterfront Living', desc: 'Direct marina access, bay views, and resort-style amenities at your doorstep.' },
  { icon: Key, title: 'Flexible Stays', desc: 'Short-term, long-term, and monthly arrangements tailored to your needs.' },
];
...
export default function HomePage() {
  ...
  useEffect(() => {
    fetch('/api/properties?status=approved')
      .then(r => r.json())
      .then((data: Property[]) => setFeatured(data.slice(0, 3)))
      .catch(() => {});
  }, []);
    ...
    <div>
      ...
      <section className="py-24 bg-[#0B1628]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white">Uncompromising Excellence</h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-[#0B1628]">Featured Residences</h2>
            </div>
            <Link href="/rentals" className="inline-flex items-center gap-2 text-[#C9A84C] font-semibold text-sm tracking-wider hover:gap-3 transition-all">
      ...
      <section className="py-24 bg-[#0B1628] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-4">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Own a Unit at Marina Towers?</h2>
