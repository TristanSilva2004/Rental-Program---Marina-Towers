...
// Pure in-memory store. No filesystem access of any kind.
// Seeded once when the module is first imported in the server process.
...
export function updatePropertyStatus(id: string, status: 'pending' | 'approved' | 'rejected'): Property | null {
...
export function addInquiry(inquiry: ContactInquiry): void {
  inquiries.push(inquiry);
}

export function updateInquiryStatus(id: string, status: 'new' | 'contacted' | 'closed'): ContactInquiry | null {
